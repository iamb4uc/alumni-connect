            ...
            <div class="carousel-indicators">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/platinum2.jpg" class="d-block w-100" alt="...">
                    </div>
                    ...
                    <div class="carousel-item">
                     ...
                     <span class="visually-hidden">Next</span>
                      ...
                      <h3><b> <u><i> UPCOMMING EVENTS </u></b> </i></h3>
            ...
            <div class="row gy-3 my-5">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card">
                        <img src="img/event.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">FAREWEEL</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card">
                        <img src="img/event.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">CULTURAL EVENT</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <div class="button">
                                <a href="#" class="btn btn-primary">NOTICE</a>
                            </div>
